...
#define LOG__VERBOSE                     PLOG(plog::verbose)
#define LOG__DEBUG                       PLOG(plog::debug)
#define LOG__INFO                        PLOG(plog::info)
#define LOG__WARNING                     PLOG(plog::warning)
#define LOG__ERROR                       PLOG(plog::error)
#define LOG__FATAL                       PLOG(plog::fatal)
#define LOG__NONE                        PLOG(plog::none)

#define LOG__VERBOSE_(instance)          PLOG_(instance, plog::verbose)
#define LOG__DEBUG_(instance)            PLOG_(instance, plog::debug)
#define LOG__INFO_(instance)             PLOG_(instance, plog::info)
#define LOG__WARNING_(instance)          PLOG_(instance, plog::warning)
#define LOG__ERROR_(instance)            PLOG_(instance, plog::error)
#define LOG__FATAL_(instance)            PLOG_(instance, plog::fatal)
#define LOG__NONE_(instance)             PLOG_(instance, plog::none)
